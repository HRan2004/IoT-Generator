...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        let parser0 = new g_parser_1.default('BOOLEAN', 'BOOLEAN');
        DSM.light0.switch.addListener(value => {
            value = parser0.convert(value);
            (0, utils_1.mlog)(' ├ @BIND light1.switch changed-to', value);
